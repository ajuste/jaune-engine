...
(function() {
  ...
  var FSManager    = Fs.FileSystemManager;
  ...
  HttpUtil.prototype = {
    ...
    processMultipart : function(request, cb) {
      ...
      data.form.onPart = UnderScore.bind(onFormPart, this);
    ...
    sendFile : function(fsModule, opts) {
      ...
      }, UnderScore.bind(onFileRead, this));
    },
    /**
    ...
    handleServiceSuccess : function(opts) {
      ...
      if (opts.client) {
        if (opts.rollback === true) {
          opts.client.rollbackAndClose(UnderScore.bind(end, this));
        }
        else {
          opts.client.commitAndClose(UnderScore.bind(end, this));
        }
      }
      else {
        end.call(this);
