...
(function() {
   ...
   */
    setCookieValue : function(response, name, value, duration) {
      duration = _.isString(duration) ? Date.getTimeFromEnum(duration) : duration;
     ...
     */
    getCookieValue : function(response, name) {
     ...
     * @param    {String} name The name of the cookie
     */
    removeCookie : function(response, name) {
     ...
     */
    endWithBadRequest : function(response, body) {
      this.endWithCode(response, Enums.HttpCode.BadRequest, body);
    },
    /**
     ...
     * @param   {String} value The value.
     */
    sendCookieLocale : function(response, value) {
