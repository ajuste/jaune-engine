...
(function() {
  ...
  var HttpUtil       = require("../http/http-util").HttpUtil;
  ...
  var SettingsLocale = Environment.getLocale();
  var SettingsFS     = Environment.getModulesSettings().fileSystem;
  ...
  ExpressServer.prototype = {
    ...
    setupModules : function() {
      ...
      if (true === this.configuration.static) {
        this.app.use(Express.static(this.configuration.staticConfig.path, { maxAge : settings.fileSystem.maxAge }));
      }
