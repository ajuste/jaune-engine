...
(function() {
  ...
  KoaServer.prototype = {
    ...
    setupModules : function() {
      ...
      if (_.isFunction(this.configuration.preMiddlewareSetup)) {
        this.configuration.preMiddlewareSetup(this.app);
      }

      if (_.isObject(this.configuration.i18n)) {
        KoaLocale(this.app);
        this.app.use(function* (next) {
          const locale = this.getLocaleFromQuery() || this.getLocaleFromCookie() || this.getLocaleFromHeader() || LocaleManager.getDefaultCountry()
          if (locale) {
