...
const _pgConnect = _bind(_pg.connect, _pg);
const _pgPools   = _pg.pools;
const _pgPoolGet = _bind(_pgPools.getOrCreate, _pgPools);
...
// constants
const DEBUG_CONFIG_SECTION = "jaune.debug";
...
PostgresClient.prototype.initConnection = function(client, release) {
  client.jaune = "undefined" === typeof client.jaune ? new PostgresConnection(client, release, this.env, this.debugSettings) : client.jaune;
  return client.jaune;
};
...
PostgresClient.prototype.connect = function* () {
  ...
  _pgConnect(this.opts.server, _bind(function(err, cli, done) {
...
PostgresClient.prototype.getConnectionsCountInPool = function() {
  return _pgPoolGet(this.opts.server).availableObjectsCount();
};
...
PostgresClient.prototype.getConnectionPoolSize = function() {
  return _pgPoolGet(this.opts.server).getPoolSize();
};
 ...
 */
var PostgresConnection = function(client, release, env, debugSettings) {
